<?php
    ...
    $securitySettingReadAccess = $globalModel->checkAccessRights($userID, $pageID, 'read');
    $securitySettingCreateAccess = $globalModel->checkAccessRights($userID, $pageID, 'create');
    $securitySettingWriteAccess = $globalModel->checkAccessRights($userID, $pageID, 'write');
...
<html lang="en" dir="ltr" data-bs-theme="light" data-color-theme="Blue_Theme" data-layout="vertical">
    ...
    <body>
            ...
            <div class="page-wrapper">
                ...
                <div class="body-wrapper">
                    <div class="container-fluid">
                        ...
                        <?php
                            if($newRecord){
                                require_once('components/security-setting/view/_security_setting_new.php');
                            }
                            else if(!empty($detailID)){
                                require_once('components/security-setting/view/_security_setting_details.php');
                            }
                            else{
                                require_once('components/security-setting/view/_security_setting.php');
                            }
                        ?>
                    </div>
                </div>
        ...
        <?php 
            if($newRecord){
                $scriptLink = 'security-setting-new.js';
            }
            else if(!empty($detailID)){
                $scriptLink = 'security-setting-details.js';
            }
            else{
                $scriptLink = 'security-setting.js';
            }

            echo '<script src="./components/security-setting/js/'. $scriptLink .'?v=' . rand() .'"></script>';
        ?>
    </body>
</html>
