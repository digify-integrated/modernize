<?php
    ...
    $notificationSettingReadAccess = $globalModel->checkAccessRights($userID, $pageID, 'read');
    $notificationSettingCreateAccess = $globalModel->checkAccessRights($userID, $pageID, 'create');
    $notificationSettingWriteAccess = $globalModel->checkAccessRights($userID, $pageID, 'write');
