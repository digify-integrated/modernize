<?php
    ...
    $emailSettingReadAccess = $globalModel->checkAccessRights($userID, $pageID, 'read');
    $emailSettingCreateAccess = $globalModel->checkAccessRights($userID, $pageID, 'create');
    $emailSettingWriteAccess = $globalModel->checkAccessRights($userID, $pageID, 'write');
                                                ...
                                                <ol class="breadcrumb fs-2">
                                                    <?php
                                                        ...
                                                        if(!$newRecord && !empty($detailID)){
                                                            echo '<li class="breadcrumb-item" id="email-setting-id">'. $detailID .'</li>';
                                                        }
