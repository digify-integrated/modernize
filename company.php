<?php
    ...
    $companyReadAccess = $globalModel->checkAccessRights($userID, $pageID, 'read');
    $companyCreateAccess = $globalModel->checkAccessRights($userID, $pageID, 'create');
    $companyWriteAccess = $globalModel->checkAccessRights($userID, $pageID, 'write');
                                                    ...
                                                    <ol class="breadcrumb fs-2">
                                                        <?php
                                                            ...
                                                            if(!$newRecord && !empty($detailID)){
                                                                echo '<li class="breadcrumb-item" id="company-id">'. $detailID .'</li>';
                                                            }
