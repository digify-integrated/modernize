    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header d-flex align-items-center">
                <h5 class="card-title mb-0">Country Form</h5>
                <div class="card-actions cursor-pointer ms-auto d-flex button-group">
                    <button type="submit" form="country-form" class="btn btn-success mb-0" id="submit-data">Save</button>
            ...
            <div class="card-body">
                <form id="country-form" method="post" action="#">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="mb-3">
                                <label class="col-sm-4 form-label" for="country_name">Display Name <span class="text-danger">*</span></label>
