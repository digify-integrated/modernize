        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex align-items-center">
                    ...
                    <?php
                        echo $stateDeleteAccess['total'] > 0 ? '<button type="button" class="btn btn-dark dropdown-toggle action-dropdown mb-0 d-none" data-bs-toggle="dropdown" aria-expanded="false">Action</button>
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table id="state-table" class="table border table-striped table-hover align-middle text-nowrap mb-0">
