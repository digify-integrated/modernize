        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex align-items-center">
                    <h5 class="card-title mb-0">Email Setting List</h5>
                    <div class="card-actions cursor-pointer ms-auto d-flex button-item">
                    <?php
                        echo $emailSettingDeleteAccess['total'] > 0 ? '<button type="button" class="btn btn-dark dropdown-toggle action-dropdown mb-0 d-none" data-bs-toggle="dropdown" aria-expanded="false">Action</button>
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table id="email-setting-table" class="table border table-striped table-hover align-middle text-nowrap mb-0">
