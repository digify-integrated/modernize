        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex align-items-center">
                    <h5 class="card-title mb-0">File Type List</h5>
                    <div class="card-actions cursor-pointer ms-auto d-flex button-group">
                        <?php
                            echo $fileTypeDeleteAccess['total'] > 0 ? '
                    ...
                    <div class="card-actions cursor-pointer ms-auto d-flex button-group">
                        <?php
                            echo $fileTypeReadAccess['total'] > 0 ? 
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table id="file-type-table" class="table border table-striped table-hover align-middle text-nowrap mb-0">
