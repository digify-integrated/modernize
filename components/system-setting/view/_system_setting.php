        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex align-items-center">
                    <h5 class="card-title mb-0">System Setting List</h5>
                    <div class="card-actions cursor-pointer ms-auto d-flex button-item">
                    <?php
                        echo $systemSettingDeleteAccess['total'] > 0 ? '<button type="button" class="btn btn-dark dropdown-toggle action-dropdown mb-0 d-none" data-bs-toggle="dropdown" aria-expanded="false">Action</button>
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table id="system-setting-table" class="table border table-striped table-hover align-middle text-wrap mb-0 w-100">
