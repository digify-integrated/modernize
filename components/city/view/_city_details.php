                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        <?php
                            if($cityCreateAccess['total'] > 0 || $cityDeleteAccess['total'] > 0){
                                echo $cityCreateAccess['total'] > 0 ? '<li><a class="dropdown-item" href="'. $pageLink .'&new">Create City</a></li>' : '';
                                echo $cityDeleteAccess['total'] > 0 ? '<li><button class="dropdown-item" type="button" id="delete-city">Delete City</button></li>' : '';
