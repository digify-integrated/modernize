            ...
            <div class="page-wrapper">
                ...
                <div class="body-wrapper">
                    <div class="container-fluid">
                        ...
                        <?php
                            if($newRecord){
                                require_once('components/country/view/_file_type_new.php');
                            }
                            else if(!empty($detailID)){
                                require_once('components/country/view/_file_type_details.php');
                            }
                            else{
                                require_once('components/country/view/_file_type.php');
                            }
                        ?>
                    </div>
                </div>
