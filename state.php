<?php
    ...
    $stateReadAccess = $globalModel->checkAccessRights($userID, $pageID, 'read');
    $stateCreateAccess = $globalModel->checkAccessRights($userID, $pageID, 'create');
    $stateWriteAccess = $globalModel->checkAccessRights($userID, $pageID, 'write');
                                                    ...
                                                    <ol class="breadcrumb fs-2">
                                                        <?php
                                                            ...
                                                            if(!$newRecord && !empty($detailID)){
                                                                echo '<li class="breadcrumb-item" id="state-id">'. $detailID .'</li>';
                                                            }
